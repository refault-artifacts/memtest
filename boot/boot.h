...
#define LOW_LOAD_ADDR \
	0x00010000 /* The low  load address for the main program */
#define HIGH_LOAD_ADDR \
	0x00100000 /* The high load address for the main program */
...
#define MAIN_SEG                                                     \
	0x1000 /* Segment address for the main program code          \
					   when loaded by the 16-bit \
		  bootloader */
