...
/**
 * Prints an unsigned hexadecimal number on screen starting at location
 * (row,col) in a field of at least length characters, optionally padding the
 * number with leading zeros, and optionally left-justifying instead of
 * right-justifying in the field. Returns the next column after the formatted
 * number.
 */
